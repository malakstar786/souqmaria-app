...
import { useAddressStore, ShippingAddress } from '../../../../store/address-store';
...
export default function EditShippingAddressScreen() {
  ...
  const { shippingAddresses, isLoading, error, updateShippingAddress } = useAddressStore();
  
  // Find the address to edit
  const addressToEdit = shippingAddresses.find(a => a.ShippingAddressId === addressId);

...
import { SaveShippingAddressPayload } from '../../../../utils/api-service';
  ...
  async function handleUpdate() {
    ...
    try {
      ...
      if (success) {
        ...
        Alert.alert(t('success'), t('shipping_address_updated_successfully'), [
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.header, { flexDirection }]}>
        ...
        <Text style={[styles.headerTitle, { textAlign: 'center' }]}>{t('edit_shipping_address')}</Text>
        <View style={{ width: 40 }} />
      </View>

...
import { saveBillingAddress, SaveBillingAddressPayload } from '../../../../utils/api-service';
...
export default function AddBillingAddressScreen() {
  ...
  async function handleSave() {
    ...
    const payload: SaveBillingAddressPayload = {
      ...
      UserId: user.UserID,
      CompanyId: 3044,
      IpAddress: '127.0.0.1', // TODO: Replace with real IP
    };
    try {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        ...
        <TextInput
          style={styles.input}
          placeholder="Behind Building... (optional)"
          value={address2}
          onChangeText={setAddress2}
          textContentType="none"
          autoComplete="off"
